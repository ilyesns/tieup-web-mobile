...
import { useFreelancerDetails, useGetUser } from "../apis/user_api";
...
import { PortfolioDisplayItemPopUp } from "../components/modals/PortfolioItem";
...
export const ProfilePage = () => {
  ...
  const freelancerDetailsData = useFreelancerDetails(currentUser.userId);
  const freelancerOfferData = useFreelancerOffers(currentUser.userId);
  const freelancerPortfolioData = useFreelancerPortfolio(currentUser.userId);
    ...
    <div className="bg-gray-50">
        ...
        <div className=" md:1/3">
          <div className="w-full flex flex-col items-end gap-y-5 ">
            <button
              ...
              className="rounded py-2 px-10 border hover:bg-gray-950 hover:text-white"
            >
              Edit
            </button>
      ...
      <div className="max-w-[1240px] mx-auto my-20 overflow-hidden">
        ...
        {freelancerPortfolioData.isLoading ? (
          ...
          freelancerPortfolioData.data.portfolioItems != null &&
          freelancerPortfolioData.data.portfolioItems.length !== 0 && (
            <div>
              ...
              {items
                ...
                .map((item, index) => (
                  <div
                    key={index}
                    onClick={() => {
                      openDisPortfolioPopUp(
                        portfolio.portfolioItems.find(
                          (i) => i.portfolioItemId === item.id
                        )
                      );
                    }}
                    className={`w-${
...
export function CarouselOfferArrows({ gallery }) {
  ...
  return (
    <div className="relative">
      ...
      >
        {items.length === 0 ? (
          <img src={Emptyimg} className="h-[200px] w-full object-cover" />
        ) : (
