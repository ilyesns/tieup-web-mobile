...
export const Orders = () => {
  ...
  return (
    <div className="bg-slate-50 ">
      ...
      <div className="max-w-[1240px] mx-auto mt-10 min-h-[700px]">
        <div className="flex justify-between">
          <div className="text-xl md:text-4xl  ">Orders</div>
          <form>
...
const TabBar = ({
  ...
  let ordersData = useClientOrders(currentUser.userId, currentUser.accessToken);
