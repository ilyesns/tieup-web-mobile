class ImageConstant {
  ...
  static String imgArrowRight =
      '$imagePath/send_message_arrow_direction_right_icon.svg';
  ...
  static String imgRemoveIcon = '$imagePath/remove_icon.svg';

  static String imgArrowright = '$imagePath/img_arrowright.svg';
  static String imgDashboardNav = '$imagePath/dashboard.svg';

  // Job Type images
  static String imgWork = '$imagePath/img_work.svg';
  static String imgInbox = '$imagePath/inbox-solid.svg';
  ...
  static String imgLinkedIn = '$imagePath/icons8-linkedin.svg';
  static String imgLoading = '$imagePath/loading.gif';
  ...
  static String imgNavsaved = '$imagePath/img_navsaved.svg';
  ...
  static String imgAttachIcon = '$imagePath/attachment_icon.svg';
